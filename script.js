...
let newYearText = document.getElementById('newYearText');
...
const countdownInterval = setInterval(() => {
  ...
  if (countdownValue < 0) {
    ...
    newYearText.style.display = 'block'; // Show "Happy New Year"
    triggerFireworks(); // Trigger fireworks animation after countdown
  }
}, 1000);
...
function triggerFireworks() {
    animate(); // Start fireworks animation after the countdown
}
